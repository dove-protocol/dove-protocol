...
forge script --broadcast --verify --etherscan-api-key $SNOWTRACE_KEY -vvvv script/2_DeployAMM.s.sol:DeployAMM --ffi --verifier-url https://api-testnet.snowtrace.io/api --slow