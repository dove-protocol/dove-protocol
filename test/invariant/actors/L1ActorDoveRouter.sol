...
contract L1ActorDoveRouter is StdUtils {
    ...
    function deposit(uint256 _amountADesired, uint256 _amountBDesired) external {
    ...
    function withdraw(uint256 liquidity) external {
        ...
        router.removeLiquidity(
            dove.token0(), dove.token1(), boundedLiquidity, _amount0Min, _amount1Min, address(this), block.timestamp + 1
        );
    }
}
